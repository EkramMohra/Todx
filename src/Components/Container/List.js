            ...
            <div className="container">
                <div className="list">
                    ...
                    {props.todolist.list.map((task, index) =>
                        <Task key={index} task={task} deleteTask={props.todolist.deleteTask} task_type="todolist"
                ...
                <div className="list">
                    ...
                    {props.dailylist.list.map((task, index) =>
                        <Task key={index}  task_type="dailylist" task={task} deleteTask={props.dailylist.deleteTask}
                ...
                <div className="list">
                    ...
                    {props.timedlist.list.map((task, index) =>
                        <Task key={index}  task_type="timedlist" task={task} deleteTask={props.timedlist.deleteTask}
